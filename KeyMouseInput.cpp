...
void Mouse::SetTexture(int tex) {
	texture = tex;
}

void Mouse::Draw() {
	Novice::DrawQuad(static_cast<int>(position.x), static_cast<int>(position.y),
		static_cast<int>(position.x + 16), static_cast<int>(position.y),
		static_cast<int>(position.x), static_cast<int>(position.y + 16),
		static_cast<int>(position.x + 16), static_cast<int>(position.y + 16),
		16 * animation, 0, 16, 16, texture, 0xFFFFFFFF);
}